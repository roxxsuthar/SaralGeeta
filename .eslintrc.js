  ...
  rules: {
    ...
    'jsx-a11y/label-has-associated-control': [
      2,
      {
        ...
        // See https://github.com/evcohen/eslint-plugin-jsx-a11y/blob/master/
    ...
    // : deep destructuring is not compatible https://github.com/eslint/eslint/issues/1863
    ...
    'no-octal-escape': 2,
    // disallow use of octal escape sequences in string
    // literals, such as var foo = "Copyright \251";
    ...
    'max-len': [2, 2000, 2], // specify the maximum length of a line in your program (off by default)
